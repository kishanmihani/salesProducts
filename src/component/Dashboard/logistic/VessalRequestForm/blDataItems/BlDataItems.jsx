...
export default function BlDataItems({ field, index, fields, setFields, handleRemoveFieldBlData }) {
  return (
    <Stack
                  key={`Bl${index}`}
                  spacing={2}
...
<Box sx={{ width: "100%" }}>
  ...
  <TextField
    ...
    onChange={(e) => {
      ...
      newFields[index].blAmt = parseFloat(value).toFixed(2);
      setFields(newFields);
    }}
...
<Box sx={{ width: "100%" }}>
  <TextField
    ...
    onChange={(e) => {
      ...
      newFields[index].roe = parseFloat(value).toFixed(2);
      setFields(newFields);
    }}
  ...
  <TextField
    ...
    onChange={(e) => {
      ...
      if (value.trim() === "") {
        ...
        newFields[index].cargoPriceError = "Cargo Price cannot be negative";
      } else {
  ...
  <TextField
    ...
    onChange={(e) => {
      ...
      if (value === "" || Number(value) === 0) {
        ...
        newFields[index].quantityError = "Net Quantity cannot be negative";
      } else {
